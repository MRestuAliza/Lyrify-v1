    ...
    <>
      ...
      <div className="max-w-6xl mb-[21.6rem] mx-auto">
        ...
        <div>
          ...
          <div className="py-3">
            <h3 className="font-semibold text-lg">Whats Input Link Cover Art form means?</h3>
            <p className="text-base md:text-lg">
              Input Link Cover Art from is a form provided to allow users to input a link image of the cover art of a song. This feature enables users to upload cover art images with their preferences. However, it's optional option because
              we have already prepared the default image.
            </p>
          </div>
          <div className="py-3">
